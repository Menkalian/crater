...
//
//import de.menkalian.crater.data.quesstimate.Category
//import de.menkalian.crater.data.quesstimate.Difficulty
//import de.menkalian.crater.data.quesstimate.Task
//import de.menkalian.crater.data.quesstimate.Language
//import de.menkalian.crater.server.database.guesstimate.question.IQuestionDatabase
//import de.menkalian.crater.server.util.MissingAuthenticationException
//import de.menkalian.crater.server.util.NotFoundException
//import de.menkalian.crater.server.util.UserRightsNotSufficientException
//import de.menkalian.crater.server.util.authTokenHash
...
////        @RequestHeader("auth", required = false, defaultValue = "") authToken: String,
////        @PathVariable("id") id: Int,
////        @RequestBody modifiedQuestion: Task
////    ): Task {
