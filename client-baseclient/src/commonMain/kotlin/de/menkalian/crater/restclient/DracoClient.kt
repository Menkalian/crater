...
import de.menkalian.crater.data.task.QuestionQuery
import de.menkalian.crater.data.task.Suggestion
import de.menkalian.crater.data.telemetrie.TelemetrieReport
import de.menkalian.crater.data.user.EntitledUser
import de.menkalian.crater.data.user.UserRight
...
@Suppress("unused")
class DracoClient(private val httpClientTemplate: HttpClient, private val configuration: CraterClientConfiguration) {
    ...
    inner class QuestionClient {
        ...
        fun update(
            ...
            coroutineScope.launch {
                catchErrors(onError) {
                    val created: Task = httpClient.post {
                        setAuth()
